...
{
    public class TecnocomCeco005WrapperClient : TecnocomBaseClient, ITecnocomCeco005WrapperClient
    {
        ...
        public TecnocomCeco005WrapperClient()
        {
            IdServicio = "CECO005";
        ...
        public Respuesta_CECO005_Registro_CECO005[] PrePagoDiezDias(string cuenta, string pan)
        {
